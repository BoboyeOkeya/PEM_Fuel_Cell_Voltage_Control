function [u1_hat,us] = itsmc_sat_law(x1,x2,u2,u3,y1d_dot,k1,s,int_part_of_u,phi)
...
u1_hat = (-1/L_g1_h)*(L_f_h + L_g2_h_u2 + L_g3_h_u3 - y1d_dot + int_part_of_u);
